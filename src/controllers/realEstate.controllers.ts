...
import { TRealEstate, TRealEstateList, TRealEstateRequest } from "../interfaces/realEstates.interface";
...
const createRealEstatesController = async (request: Request, response: Response): Promise<Response> => {
    ...
    const newRealEstate: TRealEstate = await createRealEstatesService(realEstateData);
